...
#                              Code appendix                                #
#############################################################################
#inner join using SQL(This code is expensive in terms of computation ,so by writting a basic function we accomplish the same thing as a "inner merge". Years 1999-2000)
